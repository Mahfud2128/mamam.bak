...
tls="$(cat ~/log-install.txt | grep -i VmessGRPC | cut -d: -f2|sed 's/ //g')"
none="$(cat ~/log-install.txt | grep -i VlessGRPC | cut -d: -f2|sed 's/ //g')"
echo -e "======================================"
...
sed -i "s/   - VmessGRPC               : $tls/   - VmessGRPC               : $tls1/g" /root/log-install.txt
...
sed -i "s/   - VlessGRPC               : $none/   - VlessGRPC               : $none1/g" /root/log-install.txt
