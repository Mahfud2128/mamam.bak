...
echo "Checking VPS"
clear
exp=$(curl -sS lino.griyadigital.xyz:81/ipvps | grep 47.254.243.18 | awk '{print$3}')
name=$(curl -sS lino.griyadigital.xyz:81/ipvps | grep 47.254.243.18 | awk '{print$2}') 
...
echo -e   "  \e[1;32m╠════════════════════════════════════════════════════════════╣\e[m" | lolcat
echo -e   "  ║ x)   Exit |    Expired: $exp ∆ Name: $name          ║\e[m"
echo -e   "  \e[1;32m╚════════════════════════════════════════════════════════════╝\e[m" | lolcat
echo -e   ""
